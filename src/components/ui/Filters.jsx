...
export default function Filters({
  ...
  // ✅ Prevent page scroll when filter or sort sidebar is active (mobile only)
  useEffect(() => {
  ...
  return (
    <>
      {/* ✅ Desktop Sidebar */}
      <div className="hidden overflow-y-auto lg:block w-72 bg-white min-h-screen sticky top-0 p-6">
          ...
          <ul className="flex flex-col gap-2 mb-6">
            <li>
              <button
                ...
                className={clsx(
                  "w-full text-left px-3 py-2 rounded-md border font-semibold transition",
        ...
        <div className="flex flex-col gap-2">
          {[
            ...
            <button
              key={option.label}
              onClick={() => setSortRange(option.range)}
              className={clsx(
